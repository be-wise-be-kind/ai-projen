...
### Plugin System
- **Plugin Manifest**: `plugins/PLUGIN_MANIFEST.yaml` - All available plugins and their options
- **Plugin Discovery**: `.ai/docs/PLUGIN_DISCOVERY.md` - How orchestrators work
